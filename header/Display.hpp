...
class Display {
 public:
  ...
  static void inline printLevelcount(Character* character) {
    std::cout << std::endl
              << "EXP(current): " << character->getExperience() << "/"
              << character->getNextExperience() << std::endl;
  }

  static void inline printType(Character* character) {
    std::cout << std::endl << "TYPE: " << character->getType() << std::endl << std::endl;
  }

  static void inline printHealth(Character* character) {
    std::cout << std::endl << "HEALTH: " << character->getHealth() << std::endl << std::endl;
  }

  static void inline printLevel(Character* character) {
    std::cout << std::endl << "LEVEL: " << character->getLevel() << std::endl << std::endl;
  }
  ...
  static void inline printCoins(Character* character) {
    std::cout << std::endl << "COINS: " << character->getCoins() << std::endl << std::endl;
  }
  ...
  static void inline printHealthMONSTER(Enemy* enemy) {
    std::cout << std::endl << "MONSTER HEALTH: " << enemy->getHealth() << std::endl << std::endl;
  }

  static void inline printLevelMONSTER(Enemy* enemy) {
    std::cout << std::endl << "MONSTER LEVEL: " << enemy->getLevel() << std::endl << std::endl;
  }

  static void inline printDeath(Character* character) {
    std::cout << std::endl << "YOU HAVE DIED." << std::endl << std::endl;
  }

  static void inline printInvalidInput() {
    std::cout << std::endl
              << "INVALID INPUT: Please enter an integer value based on the above options."
              << std::endl
              << std::endl;
    std::cout << "SELECT AN OPTION: ";
  }
  ...
  static void inline printInventoryIsEmpty(Character* character) {
    std::cout << std::endl << "INVENTORY IS EMPTY." << std::endl << std::endl;
  }
  ...
  static void inline printItemOptions(Character* character) {
    if (character->hasWeapon()) {
      std::cout << std::endl << "Equip the weapon? Y/N" << std::endl << std::endl;
    } else if (character->hasPotion()) {
      std::cout << std::endl << "Apply the potion? Y/N" << std::endl << std::endl;
    } else {
      std::cout << std::endl << "Use weapon or potion? N/W/P" << std::endl << std::endl;
    }
  }

  static void inline printUseSword() {
    std::cout << std::endl << "Sword equiped! Attack boosted." << std::endl << std::endl;
  }

  static void inline printUseDagger() {
    std::cout << std::endl << "Dagger equiped! Attack boosted." << std::endl << std::endl;
  }
  ...
  static void inline printUseAttackPotion() {
    std::cout << std::endl << "Attack potion applied. Attack boosted." << std::endl << std::endl;
  }

  static void inline printUseHealthPotion() {
    std::cout << std::endl << "Health potion applied. Health recovered." << std::endl << std::endl;
  }
  ...
  static void inline printItemBuyFail() {
    std::cout << std::endl << "Not enough coins to buy." << std::endl << std::endl;
  }

  static void inline printItemBuyPass() {
    std::cout << std::endl << "Item bought and added to inventory." << std::endl << std::endl;
  }
  ...
  static void inline printWinning() {
    std::cout << "You win this fight!" << std::endl;
  }

	static void inline printEnemy(int32_t id) {
		std::cout << "Fight against enemy #" << id << std::endl;
	}
